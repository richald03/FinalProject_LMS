...
$students_query = "
    ...
    AND (u.student_id LIKE ? OR u.first_name LIKE ? OR u.last_name LIKE ? OR u.email LIKE ?)
    LIMIT ? OFFSET ?";
...
$count_query = "
    ...
    AND (student_id LIKE ? OR first_name LIKE ? OR last_name LIKE ? OR email LIKE ?)";
...
<div class="main-content">
    <div class="container-fluid">
        <h2>View Students</h2>
        <!-- Search Form -->
        <form method="get" action="view_student.php" class="form-inline mb-4">
            <input type="search" name="search" class="form-control mr-2" placeholder="Search students..." value="<?php echo htmlspecialchars($search); ?>" aria-label="Search">
