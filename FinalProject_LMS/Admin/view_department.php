...
$query = "SELECT id, department_name, description, created_at FROM departments";
...
<title>TipTopLearn - View Departments</title>
...
<div class="main-content">
    ...
    <div class="card-container">
        ...
        <div class="card">
            <img src="../images/department_icon.png" alt="Department" class="avatar">
            <div class="card-body">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#detailsModal" 
                        ...
                        data-department-description="<?php echo htmlspecialchars($row['description']); ?>"
                        data-department-id="<?php echo htmlspecialchars($row['id']); ?>">View Details</button>
            </div>
        </div>
        <?php endwhile; ?>
    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailsModalLabel">Department Details</h5>
...
$(document).ready(function() {
    $('#detailsModal').on('show.bs.modal', function (event) {
        ...
        var departmentDescription = button.data('department-description');
        var departmentId = button.data('department-id');
        
        console.log("Modal opened for department:", departmentId);
        
        var modal = $(this);
        modal.find('.modal-title').text(departmentName);
        modal.find('#departmentDescription').text(departmentDescription);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var programsCourses = JSON.parse(response);
                var tableContent = '';
                
                programsCourses.forEach(function(item) {
                    tableContent += '<tr><td>' + item.program_name + '</td><td>' + (item.course_name || 'N/A') + '</td></tr>';
                });
                
                modal.find('#programCourseTable').html(tableContent);
            },
